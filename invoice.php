...
try{
  ...
  { 
    ...
    $statement = $connect->prepare("INSERT INTO inv_order (order_no, order_date, order_receiver_name, order_receiver_address, order_total_before_tax, order_total_tax1, order_total_tax2, order_total_tax3, order_total_tax, order_total_after_tax, order_datetime)
    ...
    $statement->execute(
      ...
      for($count=0; $count<$_POST["total_item"]; $count++)
      {
        ...
        $order_total_tax2 = $order_total_tax2 + floatval(trim($_POST["order_item_tax1_amount"][$count]));

        $order_total_tax3 = $order_total_tax3 + floatval(trim($_POST["order_item_tax1_amount"][$count]));
...
<!--          <?php var_dump($_REQUEST); ?>-->
            ...
            <tr>
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input type="submit" name="create_invoice" id="create_invoice" class="btn btn-success " value="SUBMIT" />
      ...
      ?>
        ...
        <nav class="navbar navbar-expand-md navbar navbar-custom navbar-fixed-top">
      <div class="container-fluid">
       ...
       <span style="color: red;">Shop</span></a>
        ...
        <a href="invoice.php?add=1" class=" btn btn-success">New Billing</a>
        </form>
          <form class="navbar-form navbar-right">
